...
import { ChangeDetectionStrategy, Component, ElementRef, OnDestroy, booleanAttribute, computed, effect, inject, input, model, signal, untracked, viewChild } from '@angular/core';
...
export class TelInputComponent implements ControlValueAccessor, MatFormFieldControl<MyTel>, OnDestroy {
  ...
  readonly id = `example-tel-input-${TelInputComponent.nextId++}`;
