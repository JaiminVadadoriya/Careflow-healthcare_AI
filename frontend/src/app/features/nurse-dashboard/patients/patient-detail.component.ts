      ...
      <div class="p-6 overflow-y-auto grow">
        ...
        @if (vitalsHistory.length > 0) {
          <div>
            ...
            <div class="space-y-3">
              @for (vital of vitalsHistory; track vital) {
                <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 flex justify-between items-center">
                  <div class="text-sm">
