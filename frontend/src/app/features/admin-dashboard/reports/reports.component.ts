...
@Component({
  ...
  template: `
    <div class="p-6 max-w-7xl mx-auto">
      ...
      <div *ngIf="!loading && dashboardData" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden min-h-[500px]">
        ...
        <div class="flex border-b border-gray-200 dark:border-gray-700">
          ...
          >
             {{ tab.label }}
             <div *ngIf="activeTab === tab.id" class="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600 dark:bg-blue-400"></div>
          </button>
        </div>
              ...
              <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
                <table class="w-full text-left border-collapse">
                   ...
                   <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                      <tr *ngFor="let user of userReports" class="hover:bg-gray-50 dark:hover:bg-gray-800/50 text-gray-900 dark:text-gray-200">
           ...
           <div *ngIf="activeTab === 'appointments'">
              ...
              <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
                <table class="w-full text-left border-collapse">
                   ...
                   <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                      <tr *ngFor="let appt of appointmentReports" class="hover:bg-gray-50 dark:hover:bg-gray-800/50 text-gray-900 dark:text-gray-200">
           ...
           <div *ngIf="activeTab === 'inventory'">
              ...
              <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
                <table class="w-full text-left border-collapse">
                   ...
                   <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                      <tr *ngFor="let item of inventoryReports" class="hover:bg-gray-50 dark:hover:bg-gray-800/50 text-gray-900 dark:text-gray-200">
