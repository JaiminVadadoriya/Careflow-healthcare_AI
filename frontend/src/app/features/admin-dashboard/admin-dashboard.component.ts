       ...
       <div class="space-y-8">
           ...
           <section>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                 <app-metric-card label="Total Users" value="120" icon="group" color="blue"></app-metric-card>
                 <app-metric-card label="Appointments" value="45" icon="event" color="green"></app-metric-card>
                 <app-metric-card label="Inventory Items" value="32" icon="inventory_2" color="yellow"></app-metric-card>
                 <app-metric-card label="Occupied Beds" value="8" icon="bed" color="red"></app-metric-card>
              </div>
           </section>
           ...
           <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
               ...
               <div class="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm h-fit">
                  ...
                  <div class="space-y-4">
                      <div *ngFor="let activity of recentActivity" class="flex gap-4 items-start">
...
export class AdminDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Layout handles user details and theme
  }
}
